...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./assets/css/ncommon.css" />
  </head>
  <body>
    <div>
      <div class="asdf">
        ...
        <div style="margin-top: -100px; margin-left: 100px; width: 500px">
        <nav id="topmenu" style="display: inline-block; width: 1000px">
          <ul>
                <li> <a class="menulink" href="index.php">main</a> </li>
                <li> <a class="menulink" href="q@a.php">Q&A</a> </li>
